...
mindmap
  root(("🎯 Proyecto\nJARVIS"))
    Entregable 1
      Documentación de casos de uso y especificación y arquitectura del sistema
    Entregable 2
      Prototipo funcional
    Entregable 3
      Documentación del funcionamiento del sistema y feedback de usuarios
    Entregable 4
...
|---|-----------|-------------|------------|------------------------|
| 1 | Documentación de casos de uso y especificación y arquitectura del sistema | Definición de los requisitos, casos de uso y arquitectura general de JARVIS, contemplando los componentes de hardware, firmware y comunicación con el sistema de gestión. | Manuela Calvo | Los requisitos y casos de uso están documentados y la arquitectura propuesta se encuentra definida y aprobada por el equipo. |
